...
#endif
#ifdef MOR1KX
#include "Vorpsoc_top_mor1kx.h"
#include "Vorpsoc_top_mor1kx_cpu.h"
#include "Vorpsoc_top_mor1kx_cpu_fourstage.h"
#endif
...
OrpsocAccess::OrpsocAccess(Vorpsoc_top * orpsoc_top)
{
	...
	mor1kx_cpu = orpsoc_top->v->mor1kx0->mor1kx_cpu->mor1kx_cpu;
#endif
...
void OrpsocAccess::setGpr(uint32_t regNum, uint32_t value)
{
  return (mor1kx_cpu->get_gpr) (regNum, value);
}
